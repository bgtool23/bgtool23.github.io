	...
	<body id="BodyID" class="ui-helper-hidden" style="overflow: hidden;height:auto;visibility:hidden;">
		<div class="preloader ui-helper-hidden"><div class="container-busy-icon"><div class="busy-icon"></div></div></div>
			<div id="title" class="ui-helper-hidden main-title ui-widget-header ui-corner-all">
				<h1>PlayStation 3 Toolset MOD for 4.82-4.89, 4.91 <span class='header-small-text'>by PSPx Team</span></h1>
				<h4 id='ps3details' class="ps3-details">Инициализация PS3 Toolset MOD v1.1 <span class='header-small-text'>build 005</span><br/>Пожалуйста, подождите...</h4>
				<form action="#">
					<select id="themes" >
			...
			<div id="tabs" class='ui-helper-hidden main-tabs ' style='height:780px;min-height:780px;'>
				...
				<div id="toolset">
					<h2 align='right' class='tab-header'>PS3 Toolset MOD <span class='header-tiny-text'>v1.1.005</span></h2>
						...
						<div class='box-table' style="max-height:620px;min-height:600px;height:620px;">
							...
							<div class='width-600 box-cell-70' >
								...
								<div>
									...
									<br/><br/>
										14/12/2022 Обновление v1.1.005
										<ul class="fa-ul">
											<li><i class="fa-li fa fa-chevron-circle-right"></i>Добавлена поддержка 4.82-4.89, 4.91 CEX<br/></li>
								...
								<div>
									<div align='left' class='wrap-don'>
										<ul class="fa-ul" style="line-height:22px;">
											...
											<li><i class="fa-li fa fa-chevron-circle-right" style="line-height:18px;"></i>Прошивка PS3: 4.82-4.89, 4.91<br/></li>											
