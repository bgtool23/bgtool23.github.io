...
function ps3chk(e) {
    ...
    switch (t) {
        ...
        case 7296336:
            ...
            break;
        case 7296344:
            helper.vshgadgets_box = "4.83" === r || "4.84" === r || "4.85" === r || "4.86" === r || "4.87" === r || "4.88" === r || "4.89" === r || "4.91" === r ? {
                vtoc_addr: 7296344,
                vshdata_seg: 7051648,
                vshopd_base: 7166648,
                vgadget1_addr: 4769668,
